...
import authorsPageInitialProps21102Resource from '../../resources/authors-page-initial-props-21102'
  ...
  return (
    <>
      <div className="authors1-container">
        <Head>
          <title>Authors1 - Principal Directives Representative</title>
          <meta
            property="og:title"
            content="Authors1 - Principal Directives Representative"
          />
        </Head>
        <DataProvider
...
export async function getStaticProps(context) {
  try {
    const response = await authorsPageInitialProps21102Resource({
      ...context?.params,
    })
    if (!response) {
      return {
